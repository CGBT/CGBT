	...
	<div id="content">		
		<div class="clearfix">
			<ul class="nav nav-pills">
			  <li class="active">
			    <a href="/admin/privileges/front/">前台权限</a>
			  </li>
			  <li>
			  	<a href="/admin/privileges/back/">后台权限</a>
			  </li>
			  <li>
			  	<a href="/admin/privileges/addfront/">添加前台权限</a>
			  </li>
			  <li>
			  	<a href="/admin/privileges/addback/">添加后台权限</a>
			  </li>
			</ul>
		</div>
