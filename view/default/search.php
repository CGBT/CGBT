	...
	<div id="ct" class="ct2_a wp cl">
		<div id="container">
			<div id="sidebar">
				...
				<div class="box-field">
					<img src="/static/images/arrow-up.png" align="absmiddle"> 上传 <?=$data['user']['uploaded_sum_text']?>
					<img src="/static/images/arrow-up-s.png" width="8" align="absmiddle" title="我发布的种子总数">
					<span title="我发布的种子总数"><?=$data['user']['total_upload_count']?></span>
					<br />
...
?>
				<div id="con<?=$i?>" <?php if ( $data['current_category'] != $category) {echo "style='display:none'";} ?>>
					...
					<dl class="fore">
						...
						<dd>
							<div>
								<a target="_blank" style="color:red;font-weight:bold;font-size:20px;" href="http://zhixing.bjtu.edu.cn/thread-797584-1-1.html">提醒新用户：BT/PT下载会造成校外计费流量</a>
							</div>
    					</dd>
					</dl>
					<?php endif; ?>
			...
			<td>
				...
				<div class="pagecontent clearfix">
					<div class="pager">
						...
						<a href="javascript:void(0);" class="button button-blue pull-left ml10" id="update_last_browse_time">更新最后浏览时间</a>
