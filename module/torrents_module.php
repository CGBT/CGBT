...
class torrents_module extends base_module
{
	...
	public function get_torrent($id)
	{
		...
		$torrents['upload_factor'] = $this->get_torrent_upload_factor($torrents);
		$torrents['download_factor'] = $this->get_torrent_download_factor($torrents);
	...
	private function get_torrent_upload_factor($torrent)
	{
		return sprintf("%.1f", 1);
	}
