...
<?php endif;?>
<link rel="stylesheet" href="/static/css/normal.css?version=20131012" />
...
<!-- <img src="http://dj.cnr.cn/index.php?post=report&task=up&contentId=559&ajax=1" style="display:none;"> -->
...
<div class="avt y">
	...
	<script>
	$(function(){
		setTimeout(ui.notify('提示', "您有未读的短消息。").effect('slide'),200);
	})
	</script>
	<?php else: ?>
	...
	<script>
	$(function(){
		setTimeout(ui.notify('提示', "您有未读的提醒。").effect('slide'),200);
	})
	</script>
	<?php else: ?>
